...
avg_results.update(
    {
        list_[0]: sum(grades[0]) / len(grades[0]),
        list_[1]: sum(grades[1]) / len(grades[1]),
        list_[2]: sum(grades[2]) / len(grades[2]),
        list_[3]: sum(grades[3]) / len(grades[3]),
        list_[4]: sum(grades[4]) / len(grades[4])
    }
)
print(avg_results)
